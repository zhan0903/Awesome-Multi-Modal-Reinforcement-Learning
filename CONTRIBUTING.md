# Contributing to Awesome Multi-Modal RL 

Anyone interested in Multi-Modal reinforcement learning is welcomed to contribute to this repo:
...
2. Clone this repo to your own machine.
    ```
    git clone https://github.com/<your_username>/awesome-multi-modal-RL.git
    ```
